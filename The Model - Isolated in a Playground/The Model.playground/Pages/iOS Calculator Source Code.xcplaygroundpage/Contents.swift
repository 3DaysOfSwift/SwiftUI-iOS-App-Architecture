...
//: -------------------
//:
//: ## Calculator Model Source Code
//:
//: Below is a real-life example of a fully complete working model of a basic calculator.
//:
//: The model is designed to mimick the simple functionality of performing one of four math operations on a left-hand-side and right-hand-side operand.
//:
//: ![View on iOS Simulator](TheView-iOSApp.png)
/*:
 */
//: 👉 Scroll to the bottom and write your own command to execute `4 * 4` and display the result in the console window.
//:
//: -------------------
//:
...
// MARK: - 📦 Layer 3 - Calculator Interface (API)
...
//: -------------------
//:
//: ## Using the Calculator Model
//:
//: 1. Instantiate one single instance of the model.
//:
//: 2. Trigger actions on the model, providing input and being ready to recieve output.
//:
//: 3. Display results to the user somehow.
//:
//: -------------------
//:
