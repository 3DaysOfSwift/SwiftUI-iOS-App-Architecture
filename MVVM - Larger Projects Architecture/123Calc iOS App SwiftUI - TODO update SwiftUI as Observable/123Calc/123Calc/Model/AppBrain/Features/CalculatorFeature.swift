...
// We named this class The Model to represent the "Model" i.e. the "System" or "thing" that when-it-functions IS THE SYSTEM without any UI connected to it.
// Model does not mean Data Model. It means, the brain 🧠 of the system - it's called the MODEL.
class Calculator: CalculatorFeature {
    // MARK: - Properties
