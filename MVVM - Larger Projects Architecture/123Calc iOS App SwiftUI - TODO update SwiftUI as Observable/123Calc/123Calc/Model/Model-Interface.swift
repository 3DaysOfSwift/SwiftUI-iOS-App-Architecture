...
// ModelAPI - Provide this Interface to who-ever wants to use a feature in the UI of an app
protocol ModelAPI {
    // Feature Objects - one to be the interface for that feature
    var calculator: CalculatorFeature { get }
}
...
/// presentation layer (UI - user interface), but is limited to extend further calculation.
protocol CalculatorFeature: Feature {
    ...
    /// this label (after each button press) the textToDisplay will automatically be updated.
